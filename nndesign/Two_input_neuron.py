...
class TwoInputNeuron(NNDLayout):
    def __init__(self, w_ratio, h_ratio):
        ...
        self.label_p1.setGeometry(75 * self.w_ratio, 200 * self.h_ratio, 30 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.wid_p1.setGeometry(50 * self.w_ratio, 250 * self.h_ratio, 50 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.label_w1.setGeometry(125 * self.w_ratio, 200 * self.h_ratio, 30 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.wid_w1.setGeometry(90 * self.w_ratio, 250 * self.h_ratio, 150 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.label_p2.setGeometry(75 * self.w_ratio, 300 * self.h_ratio, 30 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.wid_p2.setGeometry(50 * self.w_ratio, 350 * self.h_ratio, 50 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.label_w2.setGeometry(125 * self.w_ratio, 300 * self.h_ratio, 30 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.wid_w2.setGeometry(90 * self.w_ratio, 350 * self.h_ratio, 150 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.label_b.setGeometry(245 * self.w_ratio, 350 * self.h_ratio, 30 * self.w_ratio, 100 * self.h_ratio)
        self.slider_b = QtWidgets.QSlider(QtCore.Qt.Vertical)
        ...
        self.wid_b.setGeometry(240 * self.w_ratio, 350 * self.h_ratio, 150 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.label_n.setGeometry(330 * self.w_ratio, 300 * self.h_ratio, 50 * self.w_ratio, 100 * self.h_ratio)
        self.slider_n = QtWidgets.QSlider(QtCore.Qt.Vertical)
        self.slider_n.setRange(-60, 60)
        self.slider_n.setTickPosition(QtWidgets.QSlider.TicksLeft)
        self.slider_n.setTickInterval(1)
        ...
        self.wid_n.setGeometry(290 * self.w_ratio, 300 * self.h_ratio, 150 * self.w_ratio, 100 * self.h_ratio)
        ...
        self.label_a.setGeometry(420 * self.w_ratio, 300 * self.h_ratio, 50 * self.w_ratio, 200 * self.h_ratio)
        self.slider_a = QtWidgets.QSlider(QtCore.Qt.Vertical)
        self.slider_a.setRange(-60, 60)
        self.slider_a.setTickPosition(QtWidgets.QSlider.TicksLeft)
        ...
        self.wid_a.setGeometry(370 * self.w_ratio, 300 * self.h_ratio, 150 * self.w_ratio, 200 * self.h_ratio)
    ...
    def slide(self):
        ...
        self.label_n.setText("n: {}".format(n))
        a = self.func(n)
        self.slider_a.setValue(a * 10)
        self.label_a.setText("a: {}".format(a))
