...
class HammingClassification(NNDLayout):
    def __init__(self, w_ratio, h_ratio):
        ...
        self.fill_chapter("Hamming Classification", 3, " Alter the weight and bias\n and input by dragging the\n triangular"
        ...
        self.label_w1.setGeometry(300 * self.w_ratio, 300 * self.h_ratio, 150 * self.w_ratio, 25 * self.h_ratio)
        ...
        self.label_w2.setGeometry(300 * self.w_ratio, 360 * self.h_ratio, 150 * self.w_ratio, 25 * self.h_ratio)

        self.label_p = QtWidgets.QLabel(self)
        self.label_p.setText("")
        self.label_p.setFont(QtGui.QFont("Times New Roman", 12, italic=True))
        self.label_p.setGeometry(300 * self.w_ratio, 390 * self.h_ratio, 150 * self.w_ratio, 25 * self.h_ratio)
        ...
        self.label_a_11.setGeometry(300 * self.w_ratio, 420 * self.h_ratio, 150 * self.w_ratio, 25 * self.h_ratio)
        ...
        self.label_a_12.setGeometry(300 * self.w_ratio, 450 * self.h_ratio, 150 * self.w_ratio, 25 * self.h_ratio)
        ...
        self.label_a_21.setGeometry(300 * self.w_ratio, 480 * self.h_ratio, 150 * self.w_ratio, 25 * self.h_ratio)
        ...
        self.label_a_22.setGeometry(300 * self.w_ratio, 510 * self.h_ratio, 150 * self.w_ratio, 25 * self.h_ratio)
        ...
        self.label_fruit.setGeometry(300 * self.w_ratio, 540 * self.h_ratio, 150 * self.w_ratio, 25 * self.h_ratio)
    ...
    def update_label(self):
        if self.idx == 0:
            ...
            self.a2 = np.array([[self.poslin(self.a2[0, 0])], [self.poslin(self.a2[1, 0])]])
